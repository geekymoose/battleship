...
/**
 * <h1>ClickHexaPlaceBoat</h1>
 * <p>
 * public class ClickHexaPlaceBoat<br/>
 ...
 */
public class ClickHexaPlaceBoat implements ClickType{
    @Override
    ...
    public void mouseMoved(int x, int y, GridController c){
        Point p = GridCalculator.pxToHexaCoor(x, y, c.getBoxDimension().height);
